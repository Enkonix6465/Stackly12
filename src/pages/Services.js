    ...
    <>
      ...
      <section className="explore-services-section">
        ...
        <div className="explore-services-grid">
          ...
          <div className="explore-service-card">
            <div className="image-wrapper">
              <img src={cf} alt="Customer First" />
            </div>
            <Link to="/customer-first" className="explore-service-label">{t('customerFirst')}</Link>
          </div>
          ...
          <div className="explore-service-card">
            ...
            <Link to="/data-ai" className="explore-service-label">{t('dataAi')}</Link>
          </div>

          <div className="explore-service-card">
            <div className="image-wrapper">
              <img src={em} alt="Enterprise Management" />
            </div>
            <Link to="/enterprise-management" className="explore-service-label">{t('enterpriseManagement')}</Link>
          </div>
          ...
          <div className="explore-service-card">
            ...
            <Link to="/intelligent-industry" className="explore-service-label">{t('intelligentIndustry')}</Link>
          </div>
