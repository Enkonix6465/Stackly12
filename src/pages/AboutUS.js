...
<section class="expert-team-section">
  <h2 class="expert-team-title">{t('expertTitle')}</h2>
  <p class="expert-team-subtitle">{t('expertSubtitle')}</p>

  <div class="expert-testimonials">

    <div class="expert-card">
      <img src={men1} alt="John Doe" class="expert-photo" />
      <div class="expert-name">John Doe</div>
      <div class="expert-position">{t('expert1Pos')}</div>
      <div class="expert-text">{t('expert1Text')}</div>
    </div>

    <div class="expert-card">
      <img src={lady} alt="Sarah Smith" class="expert-photo" />
      <div class="expert-name">Sarah Smith</div>
      <div class="expert-position">{t('expert2Pos')}</div>
      <div class="expert-text">{t('expert2Text')}</div>
    </div>

    <div class="expert-card">
      <img src={men2} alt="Michael Brown" class="expert-photo" />
      <div class="expert-name">Michael Brown</div>
      <div class="expert-position">{t('expert3Pos')}</div>
      <div class="expert-text">{t('expert3Text')}</div>
    </div>
